...
timestamp: 2026-09-03T06:15:42.267Z
---
...
- Tests: `tests/cli/mcp.test.ts`, `tests/cli/shared-db.test.ts`, `tests/integration/bridge-serve-mode.test.ts`, `tests/cli/bridge-handlers.test.ts`, `tests/desktop/study-offers.test.ts`
