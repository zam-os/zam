...
- [x] **Phase 3 — fewer remote reads during bootstrap**
...
Done on 2026-09-12. Read counts measured by wrapping `db.prepare` around the
real bootstrap composition on a seeded local database (20 tokens, 20 cards):
