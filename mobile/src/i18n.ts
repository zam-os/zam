...
const DE: Messages = {
  ...
  library_draft: "Entwurf",
  library_draft_note: "Entwurf — noch nicht in der Abfrage",
  library_publish: "Veröffentlichen",
  library_published: "Veröffentlicht. Die Karte kann in die Abfrage.",
  library_publish_blocked: "Vor dem Veröffentlichen korrigieren: {error}",
  ...
  learning_mode_label: "Modus",
  learning_mode_flash: "Flash-Modus (schnell, ohne Tippen)",
  learning_mode_answer_feedback: "Antwort-Modus mit KI-Feedback",
  learning_mode_answer_variation: "Variations-Modus mit KI-Feedback",
  learning_mode_switch_flash: "⚡ Flash",
  learning_mode_switch_feedback: "💬 KI",
  study_voice_timeout: "Wartezeit bis automatische Antwort",
  study_voice_timeout_unit: "Sekunden",
  study_learning_save: "Lernmodus speichern",
  study_learning_saved: "Lernmodus gespeichert.",
  study_learning_failed: "Lernmodus konnte nicht gespeichert werden: {error}",
  ai_heading: "KI",
  ai_desc:
  ...
  points_expected: "{count} Punkte gefragt",
  points_score: "{recalled} von {total} Punkten",
  rating_group_missed: "Nicht oder nur teilweise gewusst",
  rating_group_known: "Vollständig gewusst – wie leicht?",
  ...
  discussion_title: "Rückfrage zum Feedback",
  discussion_label: "Deine Rückfrage",
  discussion_placeholder: "Was möchtest du genauer verstehen?",
  discussion_send: "Rückfrage senden",
  discussion_learner: "Du",
  discussion_zam: "ZAM",
  discussion_thinking: "Antwort wird formuliert …",
  discussion_failed:
    "Rückfrage konnte nicht beantwortet werden ({error}). Bitte erneut versuchen.",
...
const EN: Messages = {
  ...
  library_saved: "Saved.",
  library_draft: "Draft",
  library_draft_note: "Draft — not yet in the recall queue",
  library_publish: "Publish",
  library_published: "Published. The card can now appear in review.",
  library_publish_blocked: "Fix this before publishing: {error}",
  ...
  learning_mode_flash: "Flash mode (fast, no typing)",
  learning_mode_answer_feedback: "Answer mode with AI feedback",
  learning_mode_answer_variation: "Variation mode with AI feedback",
  learning_mode_switch_flash: "⚡ Flash",
  learning_mode_switch_feedback: "💬 AI",
  study_voice_timeout: "Auto-reveal delay",
  study_voice_timeout_unit: "seconds",
  study_learning_save: "Save learning mode",
  study_learning_saved: "Learning mode saved.",
  study_learning_failed: "Could not save learning mode: {error}",
  ai_heading: "AI",
  ai_desc:
  ...
  points_expected: "{count} points asked for",
  points_score: "{recalled} of {total} points",
  rating_group_missed: "Not, or only partly, recalled",
  rating_group_known: "Fully recalled — how easy?",
  rating_again: "Again",
  rating_hard: "Hard",
  rating_good: "Good",
  rating_easy: "Easy",
  ...
  discussion_title: "Follow up on the feedback",
  discussion_label: "Your follow-up",
  discussion_placeholder: "What would you like to understand better?",
  discussion_send: "Send follow-up",
  discussion_learner: "You",
  discussion_zam: "ZAM",
  discussion_thinking: "Writing a reply …",
  discussion_failed:
    "Could not answer the follow-up ({error}). Please try again.",
