...
export const TRANSLATION_PACKS: Record<string, Record<string, string>> = {
  es: {
    ...
    server_db_connected: "Conectado ({kind}): {location}. Emparejamiento móvil desbloqueado.",
    server_db_fields_required: "Se requieren URL y token de autenticación.",
    server_db_error: "Base del servidor: {message}",
    server_db_pair_blocked: "Conecta primero una base de datos del servidor (sección de arriba).",
settings_mobile_title: "Compañero móvil",
    ...
    pairing_choose_user:
      "Elige o crea un alumno y genera después el código.",
  ...
  fr: {
    ...
    server_db_connected: "Connecté ({kind}) : {location}. Appairage mobile débloqué.",
    server_db_fields_required: "L'URL et le jeton d'authentification sont requis.",
    server_db_error: "Base serveur : {message}",
    server_db_pair_blocked: "Connectez d'abord une base de données serveur (section ci-dessus).",
settings_mobile_title: "Compagnon mobile",
    ...
    pairing_expired:
      "QR code masqué. Générez-en un nouveau si nécessaire.",
  ...
  pt: {
    ...
    server_db_local_only: "Apenas banco local. Conecte um banco do servidor para ativar o pareamento móvel.",
    server_db_active: "Banco do servidor ativo ({kind}): {location}",
    server_db_connecting: "Verificando banco de dados do servidor…",
    server_db_connected: "Conectado ({kind}): {location}. Pareamento móvel liberado.",
    server_db_fields_required: "URL e token de autenticação são obrigatórios.",
    server_db_error: "Banco do servidor: {message}",
    server_db_pair_blocked: "Conecte primeiro um banco de dados do servidor (seção acima).",
settings_mobile_title: "Companheiro móvel",
    ...
    pairing_choose_user:
      "Escolha ou crie um aluno e depois gere o código.",
    ...
    pairing_expired:
      "Código QR ocultado. Gere outro se ainda for necessário.",
    ...
    recall_sent_to_host: "Resposta enviada à conversa do host. Continue por lá.",
  ...
  zh: {
    ...
    server_db_help: "连接 Turso/sqld 以解锁多设备与手机配对。本地 SQLite 仍可用于单机。",
...
settings_mobile_title: "移动伴侣",
  ...
  ja: {
    ...
    server_db_help: "Turso/sqld を接続するとマルチデバイスとモバイルペアリングが有効になります。ローカル SQLite は単一マシン用のまま使えます。",
    ...
    server_db_local_only: "ローカルデータベースのみ。モバイルペアリングにはサーバー DB を接続してください。",
    server_db_active: "サーバーデータベース有効（{kind}）: {location}",
    server_db_connecting: "サーバーデータベースを検証中…",
    server_db_connected: "接続済み（{kind}）: {location}。モバイルペアリングが有効です。",
    server_db_fields_required: "URL と認証トークンが必要です。",
    server_db_error: "サーバーデータベース: {message}",
    server_db_pair_blocked: "先にサーバーデータベースを接続してください（上のセクション）。",
settings_mobile_title: "モバイルコンパニオン",
    ...
    pairing_expired: "QR コードを非表示にしました。必要なら再生成してください。",
...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    pairing_choose_user:
      "Choose or create a learner, then generate the code.",
