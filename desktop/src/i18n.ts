...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    settings_mobile_help:
      "Pair an Android device with this server database and one learner.",
    pairing_open: "Pair mobile device",
    pairing_title: "Pair mobile device",
    pairing_description:
      "The QR code contains live database and optional AI credentials. It is created only for the selected learner.",
    ...
    pairing_server_required:
      "Mobile pairing requires a configured Turso/sqld server database.",
    pairing_choose_user:
