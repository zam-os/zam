...
export const TRANSLATION_PACKS: Record<string, Record<string, string>> = {
  es: {
    ...
    stats_kicker: "Actividad de repaso",
    stats_title: "Estadísticas de aprendizaje",
    stats_subtitle:
      "Tarjetas trabajadas por día, semana o mes — y el tiempo de estudio dedicado.",
    btn_stats_back: "Volver al panel",
    ...
    lbl_study_busy_saving: "Guardando tu valoración…",
    lbl_study_busy_next: "Cargando la siguiente tarjeta…",
    ...
    recall_points_expected: "Se piden {count} puntos",
    recall_points_score: "{recalled} de {total} puntos",
    lbl_rating_group_missed: "No lo sabías, o solo en parte",
    lbl_rating_group_known: "Lo sabías del todo: ¿con qué facilidad?",
    lbl_rate_1: "Otra vez",
    lbl_rate_2: "Difícil",
    lbl_rate_3: "Bien",
    lbl_rate_4: "Fácil",
    ...
    settings_subtitle:
      "Empieza con las pocas opciones que necesitas para aprender cada día.",
    settings_mode_label: "Nivel de ajustes",
    settings_mode_simple: "Sencillo",
    settings_mode_advanced: "Avanzado",
    settings_mode_simple_help: "Solo las opciones de uso diario.",
    settings_mode_advanced_help:
      "También muestra conexiones, bases de datos y ajustes detallados.",
    settings_learning_title: "Aprendizaje",
    settings_learning_help:
      "Elige cómo funcionan las tarjetas durante un repaso.",
    study_learning_saved: "Modo de aprendizaje guardado.",
    study_learning_load_failed:
      "No se pudieron cargar los ajustes de aprendizaje: {message}",
    ...
    lbl_card_status_draft: "Borrador",
    btn_publish_card: "Publicar",
    lbl_publish_ready: "Lista para publicar.",
    lbl_publish_notes: "Merece un vistazo antes de publicar:",
    lbl_publish_blocked: "Corrige esto antes de publicar:",
    lbl_published_toast: "Publicada. Ya puede aparecer en el repaso.",
    lbl_err_publish_question_required: "Hace falta una pregunta para publicar.",
    lbl_card_due: "Vence",
    toast_cell_enrolled: "¡Ruta '{title}' activada ({cards} tarjetas creadas)!",
    toast_cell_already_enrolled: "La ruta '{title}' ya está activa.",
    lbl_tier_fast: "Comprobación rápida",
    lbl_tier_synthesis: "Síntesis",
  ...
  fr: {
    ...
    stats_kicker: "Activité de révision",
    stats_title: "Statistiques d'apprentissage",
    stats_subtitle:
      "Cartes travaillées par jour, semaine ou mois — et le temps d'étude consacré.",
    btn_stats_back: "Retour au tableau de bord",
    ...
    lbl_study_busy_saving: "Enregistrement de votre évaluation…",
    lbl_study_busy_next: "Chargement de la carte suivante…",
    ...
    recall_points_expected: "{count} points attendus",
    recall_points_score: "{recalled} sur {total} points",
    lbl_rating_group_missed: "Pas su, ou seulement en partie",
    lbl_rating_group_known: "Su entièrement — avec quelle facilité ?",
    lbl_rate_1: "À revoir",
    ...
    settings_subtitle:
      "Commencez par les quelques choix utiles à l’apprentissage quotidien.",
    settings_mode_label: "Niveau des paramètres",
    settings_mode_simple: "Simple",
    settings_mode_advanced: "Avancé",
    settings_mode_simple_help: "Uniquement les choix du quotidien.",
    settings_mode_advanced_help:
      "Affiche aussi les connexions, les bases de données et les réglages détaillés.",
    settings_learning_title: "Apprentissage",
    settings_learning_help:
      "Choisissez le comportement des cartes pendant une révision.",
    study_learning_saved: "Mode d’apprentissage enregistré.",
    study_learning_load_failed:
      "Impossible de charger les paramètres d’apprentissage : {message}",
    ...
    lbl_card_status_draft: "Brouillon",
    btn_publish_card: "Publier",
    lbl_publish_ready: "Prête à publier.",
    lbl_publish_notes: "À regarder avant de publier :",
    lbl_publish_blocked: "Corrigez ceci avant de publier :",
    lbl_published_toast:
      "Publiée. Elle peut maintenant apparaître en révision.",
    lbl_err_publish_question_required: "Une question est requise pour publier.",
    lbl_card_due: "Dû",
    toast_cell_enrolled: "Parcours '{title}' activé ({cards} cartes créées) !",
    toast_cell_already_enrolled: "Le parcours '{title}' est déjà actif.",
    lbl_tier_fast: "Vérification rapide",
    lbl_tier_synthesis: "Synthèse",
  ...
  pt: {
    ...
    stats_kicker: "Atividade de revisão",
    stats_title: "Estatísticas de aprendizagem",
    stats_subtitle:
      "Cartões trabalhados por dia, semana ou mês — e o tempo de estudo dedicado.",
    btn_stats_back: "Voltar ao painel",
    ...
    lbl_study_busy_saving: "Salvando sua avaliação…",
    lbl_study_busy_next: "Carregando o próximo cartão…",
    ...
    recall_points_expected: "{count} pontos pedidos",
    recall_points_score: "{recalled} de {total} pontos",
    lbl_rating_group_missed: "Não soube, ou soube só em parte",
    lbl_rating_group_known: "Soube por completo — com que facilidade?",
    lbl_rate_1: "De novo",
    lbl_rate_2: "Difícil",
    lbl_rate_3: "Bom",
    lbl_rate_4: "Fácil",
    ...
    settings_subtitle:
      "Comece pelas poucas escolhas necessárias para estudar no dia a dia.",
    settings_mode_label: "Nível das configurações",
    settings_mode_simple: "Simples",
    settings_mode_advanced: "Avançado",
    settings_mode_simple_help: "Apenas as escolhas do dia a dia.",
    settings_mode_advanced_help:
      "Também mostra conexões, bancos de dados e ajustes detalhados.",
    settings_learning_title: "Aprendizagem",
    settings_learning_help:
      "Escolha como os cartões funcionam durante uma revisão.",
    study_learning_saved: "Modo de aprendizagem salvo.",
    study_learning_load_failed:
      "Não foi possível carregar as configurações de aprendizagem: {message}",
    ...
    lbl_card_status_draft: "Rascunho",
    btn_publish_card: "Publicar",
    lbl_publish_ready: "Pronta para publicar.",
    lbl_publish_notes: "Vale a pena ver antes de publicar:",
    lbl_publish_blocked: "Corrija isto antes de publicar:",
    lbl_published_toast: "Publicada. Já pode aparecer na revisão.",
    lbl_err_publish_question_required:
      "É necessária uma pergunta para publicar.",
    lbl_card_due: "Vence",
    toast_cell_enrolled: "Trilha '{title}' ativada ({cards} cartas criadas)!",
    toast_cell_already_enrolled: "A trilha '{title}' já está ativa.",
    lbl_tier_fast: "Verificação rápida",
    lbl_tier_synthesis: "Síntese",
    btn_import_curriculum: "Importar currículo",
  ...
  zh: {
    ...
    study_evaluation_unavailable: "AI 反馈暂时不可用。请在设置中检查 AI 模型。",
    ...
    stats_kicker: "复习活动",
    stats_title: "学习统计",
    stats_subtitle: "按天、周或月统计复习的卡片数，以及投入的学习时间。",
    btn_stats_back: "返回仪表板",
    stats_period_day: "天",
    stats_period_week: "周",
    ...
    lbl_study_busy_saving: "正在保存你的评分…",
    lbl_study_busy_next: "正在加载下一张卡片…",
    ...
    recall_points_expected: "需要 {count} 个要点",
    recall_points_score: "{total} 个要点中答对 {recalled} 个",
    lbl_rating_group_missed: "没想起来，或只想起一部分",
    lbl_rating_group_known: "完全想起来了——有多容易？",
    lbl_rate_1: "重来",
    lbl_rate_2: "困难",
    lbl_rate_3: "良好",
    lbl_rate_4: "容易",
    ...
    settings_title: "设置",
    settings_subtitle: "先从日常学习真正需要的少量选项开始。",
    settings_mode_label: "设置级别",
    settings_mode_simple: "简单",
    settings_mode_advanced: "高级",
    settings_mode_simple_help: "仅显示日常使用的选项。",
    settings_mode_advanced_help: "同时显示连接、数据库和详细调整。",
    settings_learning_title: "学习",
    settings_learning_help: "选择复习时卡片的使用方式。",
    study_learning_saved: "学习模式已保存。",
    study_learning_load_failed: "无法加载学习设置：{message}",
    settings_back: "返回仪表板",
    ...
    lbl_card_status_draft: "草稿",
    btn_publish_card: "发布",
    lbl_publish_ready: "可以发布。",
    lbl_publish_notes: "发布前值得看一下：",
    lbl_publish_blocked: "发布前请先修正：",
    lbl_published_toast: "已发布。现在可以出现在复习队列中。",
    lbl_err_publish_question_required: "发布需要填写问题。",
    lbl_card_due: "到期",
    toast_cell_enrolled: "学习路径 '{title}' 已激活（创建了 {cards} 张卡片）！",
    toast_cell_already_enrolled: "学习路径 '{title}' 已经处于激活状态。",
    lbl_tier_fast: "快速检查",
    lbl_tier_synthesis: "综合",
  ...
  ja: {
    ...
    stats_title: "学習統計",
    stats_subtitle: "日・週・月ごとの復習カード数と、費やした学習時間。",
    btn_stats_back: "ダッシュボードに戻る",
    stats_period_day: "日",
    stats_period_week: "週",
    stats_period_month: "月",
    ...
    lbl_study_busy_saving: "評価を保存しています…",
    lbl_study_busy_next: "次のカードを読み込んでいます…",
    ...
    recall_points_expected: "{count} 点が問われています",
    recall_points_score: "{total} 点中 {recalled} 点",
    lbl_rating_group_missed: "思い出せなかった／一部だけ",
    lbl_rating_group_known: "完全に思い出せた — どのくらい簡単？",
    lbl_rate_1: "もう一度",
    lbl_rate_2: "難しい",
    lbl_rate_3: "良い",
    lbl_rate_4: "簡単",
    ...
    settings_title: "設定",
    settings_subtitle: "毎日の学習に必要な少数の項目から始めます。",
    settings_mode_label: "設定レベル",
    settings_mode_simple: "かんたん",
    settings_mode_advanced: "詳細",
    settings_mode_simple_help: "日常的に使う項目だけを表示します。",
    settings_mode_advanced_help: "接続、データベース、細かな調整も表示します。",
    settings_learning_title: "学習",
    settings_learning_help: "復習中のカードの動作を選びます。",
    study_learning_saved: "学習モードを保存しました。",
    study_learning_load_failed: "学習設定を読み込めませんでした：{message}",
    ...
    lbl_card_status_draft: "下書き",
    btn_publish_card: "公開",
    lbl_publish_ready: "公開できます。",
    lbl_publish_notes: "公開前に一度確認を：",
    lbl_publish_blocked: "公開する前に直してください：",
    lbl_published_toast: "公開しました。復習に出せます。",
    lbl_err_publish_question_required: "公開するには質問が必要です。",
    lbl_card_due: "期限",
    toast_cell_enrolled:
      "学習パス '{title}' が有効化されました（{cards}枚のカードを作成）！",
    toast_cell_already_enrolled:
      "学習パス '{title}' は既に有効になっています。",
    lbl_tier_fast: "クイックチェック",
    lbl_tier_synthesis: "総合",
...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    btn_stats_back: "Back to dashboard",
    ...
    lbl_study_busy_saving: "Saving your rating…",
    lbl_study_busy_next: "Loading the next card…",
    ...
    recall_points_expected: "{count} points asked for",
    recall_points_score: "{recalled} of {total} points",
    lbl_rating_group_missed: "Not, or only partly, recalled",
    lbl_rating_group_known: "Fully recalled — how easy was it?",
    lbl_rate_1: "Again",
    lbl_rate_2: "Hard",
    lbl_rate_3: "Good",
    lbl_rate_4: "Easy",
    ...
    lbl_precondition_title: "Do you already know this?",
    lbl_precondition_body:
      "Before the question: do you already have “{title}”?",
    btn_precondition_known: "Yes, I already know this",
    btn_precondition_learn: "I want to learn it",
    lbl_keep_going_title: "Nothing left for today",
    lbl_keep_going_body:
    ...
    btn_session_done: "Stop for today",
    lbl_bonus_title: "One idea beside the path",
    lbl_bonus_body:
      "Because you can already do “{because}”, “{title}” opens. It opens {unlocks} more. Not homework — just an offer.",
    btn_bonus_accept: "Save for later",
    btn_bonus_skip: "Not now",
    ...
    settings_subtitle:
      "Start with the few choices you need for everyday learning.",
    settings_mode_label: "Settings level",
    settings_mode_simple: "Simple",
    settings_mode_advanced: "Advanced",
    settings_mode_simple_help: "Only the choices you need day to day.",
    settings_mode_advanced_help:
      "Also show connections, databases, and detailed tuning.",
    settings_learning_title: "Learning",
    settings_learning_help: "Choose how cards behave during a review.",
    study_learning_saved: "Learning mode saved.",
    study_learning_load_failed: "Could not load learning settings: {message}",
    ...
    lbl_card_status_draft: "Draft",
    btn_publish_card: "Publish",
    lbl_publish_ready: "Ready to publish.",
    lbl_publish_notes: "Worth a look before you publish:",
    lbl_publish_blocked: "Fix these before publishing:",
    lbl_published_toast: "Published. The card can now appear in review.",
    lbl_err_publish_question_required: "A question is required to publish.",
    lbl_card_due: "Due",
    ...
    toast_cell_enrolled:
      "Learning path '{title}' activated ({cards} cards created)!",
    toast_cell_already_enrolled: "Learning path '{title}' is already active.",
    lbl_tier_fast: "Quick check",
    lbl_tier_synthesis: "Synthesis",
    ...
    onboarding_goal_topics_failed:
      "No cards yet for: {topics}. Reason: {message}",
  ...
  de: {
    ...
    btn_stats_back: "Zurück zur Übersicht",
    ...
    lbl_study_busy_saving: "Speichere deine Bewertung…",
    lbl_study_busy_next: "Lade die nächste Karte…",
    ...
    recall_points_expected: "{count} Punkte gefragt",
    recall_points_score: "{recalled} von {total} Punkten",
    lbl_rating_group_missed: "Nicht oder nur teilweise gewusst",
    lbl_rating_group_known: "Vollständig gewusst – wie leicht?",
    lbl_rate_1: "Nochmal",
    lbl_rate_2: "Schwer",
    lbl_rate_3: "Gut",
    lbl_rate_4: "Einfach",
    ...
    lbl_precondition_title: "Kannst du das schon?",
    lbl_precondition_body: "Bevor die Frage kommt: Kannst du „{title}“ schon?",
    btn_precondition_known: "Ja, kann ich schon",
    btn_precondition_learn: "Will ich lernen",
    lbl_keep_going_title: "Für heute ist nichts mehr da",
    lbl_keep_going_body:
      "Das Tageslimit gibt es aus einem Grund. Wenn du willst, kannst du mit dem weiterlernen, was schon auf deinem Weg liegt.",
    btn_keep_going: "Noch ein bisschen weiter",
    btn_session_done: "Für heute Schluss",
    lbl_bonus_title: "Eine Idee daneben",
    lbl_bonus_body:
      "Weil du „{because}“ schon kannst, öffnet sich „{title}“. Das öffnet {unlocks} weitere Wege. Keine Aufgabe — nur ein Angebot.",
    btn_bonus_accept: "Für später merken",
    btn_bonus_skip: "Jetzt nicht",
    ...
    settings_subtitle:
      "Starte mit den wenigen Entscheidungen, die du beim täglichen Lernen brauchst.",
    ...
    settings_mode_advanced_help:
      "Zeigt zusätzlich Verbindungen, Datenbanken und Feineinstellungen.",
    settings_learning_title: "Lernen",
    settings_learning_help:
      "Lege fest, wie Karten beim Wiederholen funktionieren.",
    study_learning_saved: "Lernmodus gespeichert.",
    study_learning_load_failed:
      "Lerneinstellungen konnten nicht geladen werden: {message}",
    ...
    lbl_card_status_draft: "Entwurf",
    btn_publish_card: "Veröffentlichen",
    lbl_publish_ready: "Bereit zum Veröffentlichen.",
    lbl_publish_notes: "Vor dem Veröffentlichen ansehen:",
    lbl_publish_blocked: "Vor dem Veröffentlichen korrigieren:",
    lbl_published_toast: "Veröffentlicht. Die Karte kann in die Abfrage.",
    lbl_err_publish_question_required:
      "Zum Veröffentlichen ist eine Frage nötig.",
    lbl_card_due: "Fällig",
    ...
    lbl_tier_fast: "Schnellcheck",
    lbl_tier_synthesis: "Vertiefung",
    ...
    onboarding_goal_topics_failed:
      "Noch keine Karten für: {topics}. Grund: {message}",
