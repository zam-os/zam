...
export const TRANSLATION_PACKS: Record<string, Record<string, string>> = {
  es: {
    ...
    lbl_precondition_title: "¿Ya sabes esto?",
    lbl_precondition_body: "Antes de preguntártelo: ¿ya dominas «{title}»?",
    btn_precondition_known: "Sí, ya lo sé",
    btn_precondition_learn: "Quiero aprenderlo",
    lbl_keep_going_title: "No queda nada para hoy",
    lbl_keep_going_body:
      "El límite diario está ahí por una razón. Si quieres, puedes seguir con lo que ya está en tu ruta.",
    btn_keep_going: "Seguir un poco más",
    btn_session_done: "Terminar por hoy",
    lbl_bonus_title: "Una idea al lado",
    lbl_bonus_body:
      "Como ya puedes «{because}», se abre «{title}». Abre {unlocks} caminos más. No es tarea: solo una oferta.",
    btn_bonus_accept: "Guardar para más tarde",
    btn_bonus_skip: "Ahora no",
    ...
    lbl_card_due: "Vence",
    lbl_bundled_cells_title: "Rutas de aprendizaje curadas",
    lbl_bundled_cells_desc:
      "Elige una unidad de aprendizaje curada para comenzar de inmediato:",
  ...
  fr: {
    ...
    lbl_precondition_title: "Tu connais déjà ça ?",
    lbl_precondition_body:
      "Avant de poser la question : tu maîtrises déjà « {title} » ?",
    btn_precondition_known: "Oui, je le sais déjà",
    btn_precondition_learn: "Je veux l'apprendre",
    lbl_keep_going_title: "Plus rien pour aujourd'hui",
    lbl_keep_going_body:
      "La limite quotidienne est là pour une raison. Si tu veux, tu peux continuer avec ce qui est déjà sur ton chemin.",
    btn_keep_going: "Continuer un peu",
    btn_session_done: "Arrêter pour aujourd'hui",
    lbl_bonus_title: "Une idée à côté",
    lbl_bonus_body:
      "Puisque tu sais déjà faire « {because} », « {title} » s'ouvre. Cela ouvre {unlocks} autres chemins. Ce n'est pas un devoir : juste une offre.",
    btn_bonus_accept: "Garder pour plus tard",
    btn_bonus_skip: "Pas maintenant",
    ...
    lbl_card_due: "Dû",
    lbl_bundled_cells_title: "Parcours d'apprentissage sélectionnés",
    lbl_bundled_cells_desc:
      "Choisissez un module d'apprentissage sélectionné pour commencer immédiatement :",
  ...
  pt: {
    ...
    lbl_precondition_title: "Você já sabe isso?",
    lbl_precondition_body: "Antes da pergunta: você já domina «{title}»?",
    btn_precondition_known: "Sim, já sei",
    btn_precondition_learn: "Quero aprender",
    lbl_keep_going_title: "Nada mais para hoje",
    lbl_keep_going_body:
      "O limite diário existe por um motivo. Se quiser, você pode continuar com o que já está no seu caminho.",
    btn_keep_going: "Continuar um pouco",
    btn_session_done: "Encerrar por hoje",
    lbl_bonus_title: "Uma ideia ao lado",
    lbl_bonus_body:
      "Como você já consegue «{because}», abre-se «{title}». Isso abre {unlocks} outros caminhos. Não é tarefa: só uma oferta.",
    btn_bonus_accept: "Guardar para depois",
    btn_bonus_skip: "Agora não",
    ...
    lbl_card_due: "Vence",
    lbl_bundled_cells_title: "Trilhas de aprendizagem selecionadas",
    lbl_bundled_cells_desc:
      "Escolha uma unidade de aprendizagem selecionada para começar imediatamente:",
  ...
  zh: {
    ...
    lbl_precondition_title: "你已经会这个了吗？",
    lbl_precondition_body: "提问之前：你已经掌握「{title}」了吗？",
    btn_precondition_known: "会了",
    btn_precondition_learn: "我想学",
    lbl_keep_going_title: "今天的卡片做完了",
    lbl_keep_going_body:
      "每日上限是有原因的。如果你愿意，可以继续学路上已有的内容。",
    btn_keep_going: "再学一点",
    btn_session_done: "今天到此为止",
    lbl_bonus_title: "旁边还有一条路",
    lbl_bonus_body:
      "因为你已经会「{because}」，「{title}」就打开了。它还能打开 {unlocks} 条路。这不是作业，只是一个提议。",
    btn_bonus_accept: "先记下",
    btn_bonus_skip: "现在不要",
    ...
    lbl_card_due: "到期",
    lbl_bundled_cells_title: "精选学习路径",
    lbl_bundled_cells_desc: "选择一个精选学习单元立即开始学习：",
  ...
  ja: {
    ...
    lbl_precondition_title: "もう知っている？",
    lbl_precondition_body: "質問の前に：「{title}」はもうできる？",
    btn_precondition_known: "もうできる",
    btn_precondition_learn: "学びたい",
    lbl_keep_going_title: "今日の分は終わった",
    lbl_keep_going_body:
      "一日の上限には理由がある。続けたいなら、すでに道にあるものを先に進めていい。",
    btn_keep_going: "もう少し続ける",
    btn_session_done: "今日はここまで",
    lbl_bonus_title: "となりの一歩",
    lbl_bonus_body:
      "「{because}」ができるから、「{title}」が開く。さらに {unlocks} の道が開く。課題ではない。ただの提案。",
    btn_bonus_accept: "あとで使う",
    btn_bonus_skip: "今はいい",
    ...
    lbl_card_due: "期限",
    lbl_bundled_cells_title: "キュレーションされた学習パス",
    lbl_bundled_cells_desc:
      "厳選された学習ユニットを選択してすぐに開始できます：",
