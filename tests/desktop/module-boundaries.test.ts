...
// Guards Task 2 of the MCP-Apps Studio panel plan (docs/plans/2026-07-08):
// learning-content.ts and curriculum-wizard.ts must not pull in main.ts
// (Tauri APIs + Three.js), and the bridge-transport/i18n seams they now use
// instead must stay framework-free — the MCP panel (Task 3) reuses them
// standalone, with no Tauri bridge and no Three.js in its bundle.
//
