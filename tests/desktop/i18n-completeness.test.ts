...
const PRE_EXISTING_FALLBACK_KEYS = new Set([
  ...
  "onboarding_secrets_title",
  "onboarding_secrets_body",
  "onboarding_secrets_card_title",
  "onboarding_secrets_badge",
  "onboarding_secrets_when_short",
  "onboarding_secrets_link_account",
  "onboarding_secrets_link_account_eu",
  "onboarding_secrets_link_account_choose",
  "onboarding_secrets_region_title",
  "onboarding_secrets_region_body_short",
  "onboarding_secrets_region_recommended",
  "onboarding_secrets_region_eu",
  "onboarding_secrets_region_eu_detail_short",
  "onboarding_secrets_region_us",
